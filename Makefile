...
LD_FLAGS  = \
	-X okp4/github-exporter/internal/version.Name=$(BINARY_NAME) \
	-X okp4/github-exporter/internal/version.Version=$(VERSION)  \
	-X okp4/github-exporter/internal/version.Commit=$(COMMIT)
...
.PHONY: all lint lint-go build build-go clean help
